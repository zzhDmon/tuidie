...
!function(){"use strict";function i(a,i,t,s,e,n,r){var o=10;function d(i,t){a.isLoading=!0,r.article.list({id:13,page:i,per_page:t}).then(function(i){a.diaryList=a.diaryList?a.diaryList.concat(i.articles):i.articles,a.isEmpty=!a.diaryList||!a.diaryList.length,a.isLoaded=!0,a.isLoading=!1,a.isLastPage=!!(i.articles&&i.articles.length<o)&&!a.isEmpty})}a.isEmpty=!1,a.isLoaded=!1,a.isLoading=!1,a.isLastPage=!1,a.loadMore=function(){if(a.isLoading)return;if(a.isLastPage)return;if(a.diaryList&&a.diaryList.length){if(a.diaryList.length%2)return;d(a.diaryList.length/o+1,o)}else d(1,o)},a.isLoading||(a.diaryList=null,a.isEmpty=!1,a.isLoaded=!1,d(1,o)),a.articleDetail=function(i){e.go("diary-detail",{url:i.link})}}angular.module("app").controller("MDiaryController",i),i.$inject=["$scope","$http","$window","$location","$state","$rootScope","API"]}();
...
!function(){"use strict";function t(e,t,r,c,o,a,s,l,p){e.url=s.url,e.otherSrc=t.trustAsResourceUrl(e.url),jQuery.ajaxPrefilter(function(t){if(t.crossDomain&&jQuery.support.cors){var r="http:"===window.location.protocol?"http:":"https:";t.url=r+"//cors-anywhere.herokuapp.com/"+t.url}});var i=e.otherSrc;jQuery.get(i,function(t){var r=t;r=r.replace(/data-src/g,"src").replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/g,"").replace(/https/g,"http"),e.html_src="data:text/html;charset=utf-8,"+r,$("#detail_iframe").attr("src",e.html_src)})}angular.module("app").controller("diaryDetailController",t),t.$inject=["$scope","$sce","$http","$window","$location","$state","$stateParams","$rootScope","API"]}();
!function(){"use strict";function t(t,e){t.state("diary-detail",{needAuth:!0,url:"/diary-detail/:url",title:"日记详情",templateUrl:"modules/diary-detail/diary-detail.html"})}angular.module("app").config(t),t.$inject=["$stateProvider","$urlRouterProvider"]}();
...
!function(){"use strict";function e(e,t,o,r,c,i,n,d){e.id=i.id;new QRCode(document.getElementById("sharecode_qrcode"),{text:"http://app.tuidie.top/h5/?u="+e.id+"#/signin",width:150,height:150,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.H})}angular.module("app").controller("MyShareCodeController",e),e.$inject=["$scope","$http","$window","$location","$state","$stateParams","$rootScope","API"]}();
!function(){"use strict";function e(e,t){e.state("my-sharecode",{needAuth:!0,url:"/my-sharecode/:id",title:"推荐码",templateUrl:"modules/my-sharecode/my-sharecode.html"})}angular.module("app").config(e),e.$inject=["$stateProvider","$urlRouterProvider"]}();
